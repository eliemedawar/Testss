...
def testimonials() -> list[dict[str, Any]]:
    return [
        {
            "quote": "The parallax hero sold me instantly. UniPark feels like a concierge for my car.",
            "name": "Layla K.",
            "role": "Architecture Student",
            "avatar": "https://i.pravatar.cc/120?img=47",
        },
        {
            "quote": "HTMX filters mean I can book a spot in under ten seconds. It's ridiculously smooth.",
            "name": "Omar D.",
            "role": "Graduate Researcher",
            "avatar": "https://i.pravatar.cc/120?img=55",
        },
        {
            "quote": "Switching to Arabic flips everything seamlessly. Even the icons feel right.",
            "name": "Maya S.",
            "role": "Design Lead",
